 ...
 * Use the {@link ICodeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ICodeFragment extends Fragment {
     ...
     * @return A new instance of fragment ICodeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ICodeFragment newInstance(String param1, String param2) {
        ICodeFragment fragment = new ICodeFragment();
    ...
    public void loaddata()
    {
        ...
        if(item.equals("C"))
        {
            webView.loadUrl("file:///android_asset/insertion_c.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("C++"))
        {
            webView.loadUrl("file:///android_asset/insertion_cpp.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("Java"))
        {
            webView.loadUrl("file:///android_asset/insertion_java.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("Python"))
        {
            webView.loadUrl("file:///android_asset/insertion_python.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("JavaScript"))
        {
            webView.loadUrl("file:///android_asset/insertion_js.html");
            System.out.println("C language is selected");
        }
    }
}
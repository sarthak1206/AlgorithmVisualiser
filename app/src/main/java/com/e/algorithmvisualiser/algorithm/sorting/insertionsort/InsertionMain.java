package com.e.algorithmvisualiser.algorithm.sorting.insertionsort;
...
public class InsertionMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openFragment(new IExecutionFragment());
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.details:
                        openFragment(new IDetailFragment());
                        return true;
                    ...
                    case R.id.code:
                        openFragment(new ICodeFragment());
                        return true;
    ...
    public void onBackPressed() {
        ...
        if (R.id.execution != selectedItemId) {
            setHomeItem(InsertionMain.this);
        } else {
            finish();
        }
    }

 ...
 * Use the {@link LCodeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LCodeFragment extends Fragment {
     ...
     * @return A new instance of fragment LCodeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LCodeFragment newInstance(String param1, String param2) {
        LCodeFragment fragment = new LCodeFragment();
    ...
    public void loaddata()
    {
        ...
        if(item.equals("C"))
        {
            webView.loadUrl("file:///android_asset/bubble_c.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("C++"))
        {
            webView.loadUrl("file:///android_asset/bubble_cpp.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("Java"))
        {
            webView.loadUrl("file:///android_asset/bubble_java.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("Python"))
        {
            webView.loadUrl("file:///android_asset/bubble_python.html");
            System.out.println("C language is selected");
        }
        else if(item.equals("JavaScript"))
        {
            webView.loadUrl("file:///android_asset/bubble_js.html");
            System.out.println("C language is selected");
        }
    }
}